...
class StepBuffer:
    ...
    def set_all_pages_from_track(self):
        self.for_all_pars(self.for_all_pages, row_func=self.set_row_from_track)
        self.for_all_trgs(self.for_all_pages, row_func=self.set_row_from_track)
    ...
    def set_row_from_track(self, item, offset=0):
        ...
        self.values[item] = [
            func_get[blk](step + offset, l, i) for step in range(self.page_size)
        ]
